...
import { format, formatDistance, formatRelative, subDays, compareAsc,parse } from 'date-fns'
import datefnsMatreialUi from './datefnsMatreialUi'
...
function DateRfnsTest() {
  ...
  let todayDate = format(new Date(), "yyyy-MM-dd hh:mm");
  let parsing = format(new Date(), "d.MM.yy");
  let p = parse("11.02.87", "d.MM.yy", new Date()).toString();
